...
union uvh_gr0_tlb_mmr_control_u {
	...
	struct uvh_gr0_tlb_mmr_control_s {
		...
		unsigned long	auto_valid_en:1;		
		unsigned long	rsvd_17_19:3;
		unsigned long	mmr_hash_index_en:1;		
		unsigned long	rsvd_21_29:9;
		unsigned long	mmr_write:1;			
		unsigned long	mmr_read:1;			
	...
	struct uv1h_gr0_tlb_mmr_control_s {
		...
		unsigned long	mmr_inj_con:1;			
		unsigned long	rsvd_49_51:3;
		unsigned long	mmr_inj_tlbram:1;		
		unsigned long	rsvd_53:1;
		unsigned long	mmr_inj_tlbpgsize:1;		
		unsigned long	rsvd_55:1;
		unsigned long	mmr_inj_tlbrreg:1;		
		unsigned long	rsvd_57_59:3;
		unsigned long	mmr_inj_tlblruv:1;		
	...
	struct uv3h_gr0_tlb_mmr_control_s {
		...
		unsigned long	rsvd_17_19:3;
		unsigned long	mmr_hash_index_en:1;		
		unsigned long	ecc_sel:1;			
		unsigned long	rsvd_22_29:8;
		unsigned long	mmr_write:1;			
		unsigned long	mmr_read:1;			
		unsigned long	mmr_op_done:1;			
		unsigned long	rsvd_33_47:15;
		unsigned long	undef_48:1;			
		unsigned long	rsvd_49_51:3;
		unsigned long	undef_52:1;			
		unsigned long	rsvd_53_63:11;
	} s3;
	struct uv4h_gr0_tlb_mmr_control_s {
		unsigned long	index:13;			
		unsigned long	mem_sel:2;			
...
union uvh_gr0_tlb_mmr_read_data_hi_u {
	...
	struct uv3h_gr0_tlb_mmr_read_data_hi_s {
		...
		unsigned long	dirty:1;			
		unsigned long	larger:1;			
		unsigned long	aa_ext:1;			
		unsigned long	undef_46_54:9;			
		unsigned long	way_ecc:9;			
	} s3;
	struct uv4h_gr0_tlb_mmr_read_data_hi_s {
		unsigned long	pfn:34;				
		unsigned long	pnid:15;			
		unsigned long	gaa:2;				
		unsigned long	dirty:1;			
		unsigned long	larger:1;			
		unsigned long	aa_ext:1;			
		unsigned long	undef_54:1;			
		unsigned long	way_ecc:9;			
	} s4;
};
...
union uvh_gr0_tlb_mmr_read_data_lo_u {
	...
	struct uvh_gr0_tlb_mmr_read_data_lo_s {
		unsigned long	vpn:39;				
		unsigned long	asid:24;			
...
union uvh_lb_bau_misc_control_u {
	...
	struct uvh_lb_bau_misc_control_s {
		unsigned long	rejection_delay:8;		
		unsigned long	apic_mode:1;			
		unsigned long	force_broadcast:1;		
		unsigned long	force_lock_nop:1;		
		unsigned long	qpi_agent_presence_vector:3;	
		unsigned long	descriptor_fetch_mode:1;	
		unsigned long	rsvd_15_19:5;
		unsigned long	enable_dual_mapping_mode:1;	
		unsigned long	vga_io_port_decode_enable:1;	
		unsigned long	vga_io_port_16_bit_decode:1;	
		unsigned long	suppress_dest_registration:1;	
		unsigned long	programmed_initial_priority:3;	
		unsigned long	use_incoming_priority:1;	
		unsigned long	enable_programmed_initial_priority:1;
	...
	struct uv1h_lb_bau_misc_control_s {
		...
		unsigned long	qpi_agent_presence_vector:3;	
		unsigned long	descriptor_fetch_mode:1;	
		unsigned long	enable_intd_soft_ack_mode:1;	
		unsigned long	intd_soft_ack_timeout_period:4;	
		unsigned long	enable_dual_mapping_mode:1;	
		unsigned long	vga_io_port_decode_enable:1;	
		unsigned long	vga_io_port_16_bit_decode:1;	
		unsigned long	suppress_dest_registration:1;	
	...
	struct uvxh_lb_bau_misc_control_s {
		...
		unsigned long	use_incoming_priority:1;	
		unsigned long	enable_programmed_initial_priority:1;
		unsigned long	enable_automatic_apic_mode_selection:1;
		unsigned long	apic_mode_status:1;		
		unsigned long	suppress_interrupts_to_self:1;	
		unsigned long	enable_lock_based_system_flush:1;
		unsigned long	enable_extended_sb_status:1;	
		unsigned long	suppress_int_prio_udt_to_self:1;
		unsigned long	use_legacy_descriptor_formats:1;
	...
	struct uv3h_lb_bau_misc_control_s {
		...
		unsigned long	suppress_int_prio_udt_to_self:1;
		unsigned long	use_legacy_descriptor_formats:1;
		unsigned long	suppress_quiesce_msgs_to_qpi:1;	
		unsigned long	enable_intd_prefetch_hint:1;	
		unsigned long	thread_kill_timebase:8;		
	...
	struct uv4h_lb_bau_misc_control_s {
		...
		unsigned long	thread_kill_timebase:8;		
		unsigned long	address_interleave_select:1;	
...
#define UVH_LB_BAU_SB_DESCRIPTOR_PAGE_ADDRESS_MASK (			\
	...
	is_uv4a_hub() ? UV4AH_LB_BAU_SB_DESCRIPTOR_PAGE_ADDRESS_MASK :	\
	 UV4H_LB_BAU_SB_DESCRIPTOR_PAGE_ADDRESS_MASK)
...
union uv4h_lb_proc_intd_queue_first_u {
	...
	struct uv4h_lb_proc_intd_queue_first_s {
		...
		unsigned long	first_payload_address:40;	
	} s4;
};
...
union uv4h_lb_proc_intd_queue_last_u {
	...
	struct uv4h_lb_proc_intd_queue_last_s {
		unsigned long	undef_0_4:5;			
		unsigned long	last_payload_address:41;	
	} s4;
};
...
union uv4h_lb_proc_intd_soft_ack_clear_u {
	...
	struct uv4h_lb_proc_intd_soft_ack_clear_s {
		unsigned long	soft_ack_pending_flags:8;	
	} s4;
};
...
union uv4h_lb_proc_intd_soft_ack_pending_u {
	...
	struct uv4h_lb_proc_intd_soft_ack_pending_s {
		unsigned long	soft_ack_flags:8;		
	} s4;
};
