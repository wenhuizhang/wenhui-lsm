...
#define HCI_POWER_OFF_TIMEOUT	msecs_to_jiffies(5000)	
#define HCI_LE_CONN_TIMEOUT	msecs_to_jiffies(20000)	
#define HCI_LE_AUTOCONN_TIMEOUT	msecs_to_jiffies(4000)	
