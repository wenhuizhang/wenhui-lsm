...
enum {
	...
	CEPH_OSD_OP_FLAG_FADVISE_RANDOM	    = 0x4, 
	CEPH_OSD_OP_FLAG_FADVISE_SEQUENTIAL = 0x8, 
	CEPH_OSD_OP_FLAG_FADVISE_WILLNEED   = 0x10,
	CEPH_OSD_OP_FLAG_FADVISE_DONTNEED   = 0x20,
...
enum {
	...
	CEPH_OSD_COPY_FROM_FLAG_IGNORE_OVERLAY = 2, 
	CEPH_OSD_COPY_FROM_FLAG_IGNORE_CACHE = 4,   
	CEPH_OSD_COPY_FROM_FLAG_MAP_SNAP_CLONE = 8, 
	CEPH_OSD_COPY_FROM_FLAG_RWORDERED = 16,     
};
